        ...
        content: {
          children: (
            <span>
              ...
              <p>
                {' '}
                <a href="mailto:wecare@pamushanaafrica.com">Email: wecare@pamushanaafrica.com</a>{' '}
              </p>{' '}
              <p>
                {' '}
                <a href="https://maps.google.com/?q=1813 14th Road, Harare, Zimbabwe" target ="_blank">Visit: Pamushana House Number 1813 14th Road, Harare, Zimbabwe</a>{' '}
              </p>{' '}
              <p>
                {' '}
                <a href="#">Ant Design</a>{' '}
